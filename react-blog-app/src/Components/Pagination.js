...
function Pagination(props) {
    var {articlesPerPage,articleCount,activeIndexPage,updateCurrentIndex} = props;
    ...
    return (
        <div className="w-6/12 flex items-center justify-center m-auto mt-16 mb-20 pagination">
            ...
            <p onClick={() => updateCurrentIndex(activeIndexPage + 1 > numberOfPages ? numberOfPages : activeIndexPage + 1)} className="cursor-pointer py-2 ml-4 shadow-lg bg-black text-white px-3 rounded-full"><i class="fas fa-arrow-right"></i></p>
        </div>
    )
}
