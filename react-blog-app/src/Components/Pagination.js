...
function Pagination(props) {
    ...
    return (
        <div className="w-5/12 flex items-center justify-center m-auto mt-16 mb-20 pagination">
            <p onClick={() => updateCurrentIndex(activeIndexPage-1)} className="cursor-pointer  py-2 mr-4 -mt-4 shadow-lg bg-black text-white px-3 rounded-full"><i class="fas fa-arrow-left"></i></p>
