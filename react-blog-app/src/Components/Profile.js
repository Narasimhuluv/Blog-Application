      ...
      <div className="container">
          ...
          <div className="w-2/12  flex m-auto font-light">
            ...
            <div className="w-11/12 border-l-2  text-center">
              ...
              <h4 className="font-extrabold">
                {this.props.favortedArticles.length}
              </h4>
            </div>
          </div>
        ...
        <div>
          ...
          <button
            ...
            onClick={() => this.FavoritedArticle(user.username)}
          >
            Favorited Articles
          </button>
        </div>
        ...
        <div className="mt-10 flex flex-wrap">
          {this.state.activeTab === "active"
            ? eachuserData.map((each) => <UserArticle each={each} />)
            : ""}
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <div className="flex">
            ...
            <p onClick={() => this.deleteArticle(each.slug)}>
